...
A imagem do produto está com `position: absolute`. Elemento absoluto sai do fluxo do
documento e é posicionado por coordenadas pensadas para o desktop; no mobile, com o layout em
coluna única, essas coordenadas deixam a imagem fora da área visível.

### 4. Como você corrigiria

Remover o `position: absolute` da imagem no breakpoint mobile, devolvendo-a ao fluxo do
documento para que ela apareça junto ao conteúdo do hero.
